		...
		function icon_boxes($atts, $content = null)
		{
			...
			if($pos == "heading-right" || $pos == "right"){
					...
					if($title !== ''){
						...
						//TREETHEMES
						if ($pos === 'tooltip') $title_style .= "text-align:center;margin-top:20px;";
					...
					if($content !== ''){
						...
						//TREETHEMES
						if ($pos == 'tooltip') $html .= '<span class="tooltip-arrow-down"></span>';
						...
						"params" => array(
							...
							array(
								...
								"value" => array(
									...
									//TREETHEMES
									__("Icon with Description on Tooltip","ultimate_vc") => "tooltip"
								),
